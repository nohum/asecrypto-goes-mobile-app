...
public class EuclidIterativeTask extends AsyncTask<AseInteger, Void, EuclidResult> {

    private final TaskFinishedCallable<EuclidResult> callable;

    public EuclidIterativeTask(TaskFinishedCallable<EuclidResult> callable) {
    ...
    protected EuclidResult doInBackground(AseInteger... numbers) {
        ...
        gcd = firstNumber.getGcd(secondNumber);
