...
public class EuclidFactorialTask extends AsyncTask<AseInteger, Void, EuclidResult> {

    private final TaskFinishedCallable<EuclidResult> callable;

    public EuclidFactorialTask(TaskFinishedCallable<EuclidResult> callable) {
    ...
    protected EuclidResult doInBackground(AseInteger... numbers) {
        ...
        gcd = firstNumber.getGcdFact(secondNumber);
