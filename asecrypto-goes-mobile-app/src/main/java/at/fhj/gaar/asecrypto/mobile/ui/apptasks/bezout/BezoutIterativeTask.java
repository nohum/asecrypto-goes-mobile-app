...
public class BezoutIterativeTask extends AsyncTask<AseInteger, Void, BezoutResult> {

    private final TaskFinishedCallable<BezoutResult> callable;

    public BezoutIterativeTask(TaskFinishedCallable<BezoutResult> callable) {
    ...
    protected BezoutResult doInBackground(AseInteger... numbers) {
        ...
        result = firstNumber.getBezout(secondNumber);
